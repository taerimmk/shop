...
public class LoginAdminSuccessHandlerImpl extends
		SimpleUrlAuthenticationSuccessHandler implements
		AuthenticationSuccessHandler {

	private static final Logger logger = LoggerFactory
			.getLogger(LoginAdminSuccessHandlerImpl.class);
	private RequestCache requestCache = new HttpSessionRequestCache();

	/*@Autowired
	UserRepository userRepository;*/

	public LoginAdminSuccessHandlerImpl() {
	}

	public LoginAdminSuccessHandlerImpl(String defaultTargetUrl) {
